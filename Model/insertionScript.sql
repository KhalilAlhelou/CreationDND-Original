...
INSERT INTO "class" ("idC","nameC","descC","hitPointC","isSpellcaster","bProfficiency","listAttrs") VALUES (4,'',NULL,NULL,NULL,NULL,NULL),
 (301,'Barbare','Un guerrier féroce d''origine primitive qui peut entrer dans une rage de combat.',12,0,0,'201;202'),
 ...
 (310,'Sorcier','Un lanceur de sorts qui utilise la magie inhérente d''un don ou d''une lignée.',6,1,0,'203;217'),
 (311,'Warlock','Manipulateur de magie issue d''un marché avec une entité extraplanaire.',8,0,0,'218;219'),
 (312,'Magicien','Un utilisateur de magie érudit capable de manipuler les structures de la réalité.',6,1,0,'203;220');
COMMIT;
